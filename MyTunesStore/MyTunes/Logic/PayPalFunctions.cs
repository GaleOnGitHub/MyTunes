...
public class NVPAPICaller
{
    ...
    public string APIUsername = "benatnscc-facilitator_api1.gmail.com";
    private string APIPassword = "A7J3BNTEFCNE9JPF";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A.oihiiVZGWIF.MNyAjKd5tS2mAK";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (MyTunes.Logic.ShoppingCartActions myCartOrders = new MyTunes.Logic.ShoppingCartActions())
        {
            List<CartItem> myOrderList = myCartOrders.GetCartItems();

            for (int i = 0; i < myOrderList.Count; i++)
            {
                encoder["L_PAYMENTREQUEST_0_NAME" + i] = myOrderList[i].Track.Name.ToString();
                encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].Track.UnitPrice.ToString();
            }
        }
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            MyTunes.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
